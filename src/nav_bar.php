    ...
    <div class="container px-6 py-3 mx-auto md:flex">
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
            ...
            <div class="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0">
                <a href="/src/books.php"
                    class="px-2.5 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg hover:bg-gray-100  md:mx-2">Acervo</a>
                ...
                if ($_SESSION['usertype'] == 3)
                    ...
                    <a href="/src/users.php"
                        class="px-2.5 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg hover:bg-gray-100  md:mx-2">Usuários</a>
                    ');
