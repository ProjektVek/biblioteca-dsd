...
<body class="bg-green-50">
    ...
    <div class="h-[80vh] w-full flex items-center justify-center">
        <section class="w-[35em] p-6 mx-auto bg-white rounded-md shadow-md">
            <h2 class="text-lg font-semibold text-gray-700 capitalize">Cadastrar Livro</h2>

            <form action="/src/php/book_register.php" method="post">
                <div class="grid grid-cols-1 gap-6 mt-4">
                    <div>
                        <label class="text-gray-700" for="title">Título</label>
                        <input id="title" name="title" type="text" maxlength="60" placeholder="Insira o Título"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-gray-700" for="isbn">ISBN</label>
                        <input id="isbn" name="isbn" type="text" maxlength="13" placeholder="Insira o ISBN"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring">
                    </div>
